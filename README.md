...
This project applies matching wallpapers, icons, and terminal styling through a simple one‑command installer.
...
- Everforest 7TSP icon pack  
- Windows Terminal theme (Oh‑My‑Posh)  
